...
Soy Gian Cruz y mientras buscaba data de COVID para Perú encontré que Our World in Data (OWID) mantiene un dataset abierto actualizado diariamente con datos de 200+ países, pero está en formato plano y sin ningún análisis regional. Los dashboards del MINSA muestran curvas de casos para Perú, pero no puedes comparar directamente la mortalidad per cápita de Perú contra Chile, Colombia o Brasil, ni detectar automáticamente cuándo empieza y termina cada ola, ni cruzar vacunación con letalidad.
